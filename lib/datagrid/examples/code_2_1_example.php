...
<?php
    ...
    ##  *** set data source with needed options
      $default_order_field = "demo_products.name";
    ...
    ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
      $vm_colimns = array(
        "name"              => array("header"=>"Name", "type"=>"linktoedit",  "header_tooltip"=>"Model and Model Type", "header_tooltip_type"=>"simple", "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal", "summarize"=>"false", "sort_type"=>"string", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
    ...
    ##  ***  set settings for add/edit/details modes
      ...
      $em_columns = array(
            ...
            "is_featured"   =>array("header"=>"Is Featured", "type"=>"enum",       "req_type"=>"rr", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>"self", "view_type"=>"radiobutton", "radiobuttons_alignment"=>"horizontal", "multiple"=>"false", "multiple_size"=>"4"),

            "date_added"    =>array("header"=>"", "type"=>"hidden",     "req_type"=>"st", "default"=>"NOW()", "value"=>"", "unique"=>"false", "visible"=>"true"),
      );
