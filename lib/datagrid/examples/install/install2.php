		...
		if(empty($error_mg)){
			...
			if (@fwrite($f, $config_file) > 0){
				...
				if($link){					
					...
					$error_mg[] = "Database connecting error! Check your database exists and/or connection parameters.</span><br/>";
				}
			} else {				
				$error_mg[] = "Can not open configuration file ".$config_file_directory.$config_file_name.". <br />Please make sure you have 'write' permissions (755 or 777) to <b>examples/install/</b> folder";				
			}
			@fclose($f);
