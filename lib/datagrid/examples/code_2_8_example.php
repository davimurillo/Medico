            ...
            <td valign='top'>
                ...
                <tr>
                    <td height='20'>
                        <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                        <tr>
                            <td width='100px' valign='top' style='color:#666666'>Submodel(s):&nbsp;<a class='x-gray_dg_a' href='javascript:void(0);' onclick=\"$('#submodels_{id}').toggle();\">[+]</a></td>
                            <td valign='top' style='color:#008a8a'><div id='submodels_{id}' style='display:none;'>{submodels}</div></td>
                        </tr>
                        </table>
                    </td>
                </tr>
