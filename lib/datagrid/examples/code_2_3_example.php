...
<?php
  ...
  $pr_page_size = isset($_REQUEST['pr_page_size']) ? $_REQUEST['pr_page_size'] : "";
  $pr_p         = isset($_REQUEST['pr_p']) ? $_REQUEST['pr_p'] : "";
  $pr_sort_field = isset($_REQUEST['pr_sort_field']) ? $_REQUEST['pr_sort_field'] : "";
  $pr_sort_field_by = isset($_REQUEST['pr_sort_field_by']) ? $_REQUEST['pr_sort_field_by'] : "";
  $pr_sort_type = isset($_REQUEST['pr_sort_type']) ? $_REQUEST['pr_sort_type'] : "";
