<?php
    ...
    */
    ...
    ################################################################################
    ## --------------------------------------------------------------------------- #
    ##  PHP DataGrid Pro (AJAX enabled) version 6.7.5                              #
    ##  Developed by:  ApPhp <info@apphp.com>                                      # 
    ##  License:       GNU LGPL v.3                                                #
    ##  Site:          http://www.apphp.com/php-datagrid/                          #
    ##  Copyright:     PHP DataGrid (c) 2006-2011. All rights reserved.            #
    ##                                                                             # 
    ################################################################################
    ## +---------------------------------------------------------------------------+
    ## | 1. Creating & Calling:                                                    | 
    ...
    ///     "cancel"  =>array("view"=>true, "edit"=>true,  "type"=>"link",  "show_button"=>true),
    ...
    ///     "Caption_3"=>array("type"=>"dropdownlist", "table"=>"tableName_3", "field"=>"fieldName_1",              "filter_condition"=>"", "show_operator"=>"false", "default_operator"=>"=", "case_sensitive"=>"false", "comparison_type"=>"string|numeric|binary", "width"=>"", "on_js_event"=>"", "default"=>"", "source"=>"self"|$fill_from_array, "field_view"=>"fieldName_2", "order_by_field"=>"", "order_type"=>"ASC|DESC", "condition"=>"", "show_count"=>false, "multiple"=>"false", "multiple_size"=>"4"),
    ...
    ##  --//--   : dtSeparator                 = "-"; defines a separator for datetime fields (private)
    ...
    ##  --//--   : SetCacheDirectory(); 
    ##             
    ## ATTRIBUTE : "header_tooltip"   => "false|true" - displays header tooltip in View/Add/Edit/Details modes
    ...
    ##  --//--   : "table_alias"    => "" defines table alias for filtering fields to prevent name ovelapping
    ##
