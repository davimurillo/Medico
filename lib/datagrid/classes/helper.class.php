...
## --------------------------------------------------------------------------- #
##  ApPHP DataGrid Helper Class 0.1.0 (07.07.2011)                             #
...
Class Helper
{
    ...
    //--------------------------------------------------------------------------
    static public function SubString($text, $length = "0", $lang_name = "en", $three_dots = false)
	{
    ...
    //--------------------------------------------------------------------------
	static public function FileUploadErrorMessage($error_code)
	{
		switch($error_code){ 
