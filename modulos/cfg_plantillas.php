...
##  *** put a primary key on the first place 
  	...
  	$sql="SELECT id_plantilla, tx_nombre_plantilla, ('<div width=\"16px\" height=\"16px\" style=\"background-color:'|| color || ' ;color:' || color || '\"> . </div>') as color FROM tbl_plantilla";
...
##  *** set data source with needed options
  $default_order_field = "tx_nombre_plantilla";
   ...
   //$dgrid->setAutoColumnsInViewMode(true);  
	...
	$dgrid->SetViewModeTableProperties($vm_table_properties); 
 	...
 	$vm_colimns = array(
		...
		"tx_nombre_plantilla"  =>array("header"=>"Nombre Plantilla","header_align"=>"left","type"=>"label", "width"=>"95%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
	 );
...
##  ***  set settings for edit/details mode
	...
	$em_columns = array(
		...
		"tx_nombre_plantilla" =>array("header"=>"Nombre", "type"=>"textbox", "width"=>"100%", "req_type"=>"ry", "title"=>"Nombre", "unique"=>false),
		"tx_plantilla" =>array("header"=>"Diseño", "type"=>"textarea", "width"=>"100%", "rows"=>"10", "req_type"=>"syy", "title"=>"Descripción", "unique"=>false),
...
<!-- Include JS files. -->
  ...
  <script>
	  ...
	  CKEDITOR.replace( 'syytx_plantilla', {
