...
##  *** put a primary key on the first place 
  $sql="SELECT "
   ...
   ."tx_descripcion, to_char(fecha_actualizada,'DD/MM/YYYY') AS fecha, "
...
##  *** set columns in view mode
 ...
 $vm_colimns = array(
	"id_galeria"  =>array("header"=>"ID",      "type"=>"label", "width"=>"10%", "align"=>"center",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   ...
   "tx_foto"  =>array("header"=>"Imagen", "type"=>"image",      "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"../img/galeria/", "allow_image_updating"=>"false", "max_file_size"=>"2M", "image_width"=>"150vw", "image_height"=>"80vh", "resize_image"=>"false", "resize_width"=>"128px", "resize_height"=>"128px", "magnify"=>"false", "magnify_type"=>"lightbox", "magnify_power"=>"2", "file_name"=>"", "host"=>"local", "allow_downloading"=>"false", "allowed_extensions"=>""),
	...
	"tx_descripcion" =>array("header"=>"Descripción", "type"=>"textarea", "width"=>"100%", "rows"=>"3", "req_type"=>"ry", "title"=>"", "maxlength"=>"140",  "unique"=>false),
	"id_estatus" =>array(
												"header"=>"Estatus",
												"type"=>"enum",     
