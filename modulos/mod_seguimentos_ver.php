...
##  *** put a primary key on the first place 
  	...
  	$sql=" SELECT tx_descripcion, (SELECT tx_tipo FROM cfg_objeto WHERE id_tipo_objeto=a.id_tipo) AS tipo,(SELECT tx_tipo FROM cfg_objeto WHERE id_tipo_objeto=a.id_estatus) AS estatus FROM tbl_seguimiento WHERE id_oportunidad=".$_GET['id'];
...
##  *** set columns in view mode
   //$dgrid->setAutoColumnsInViewMode(true);  
	...
	$dgrid->SetViewModeTableProperties($vm_table_properties); 
 	...
 	$vm_colimns = array(
		"tx_descripcion"  =>array("header"=>"Actividad","header_align"=>"center","type"=>"label", "width"=>"80%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
		"tipo"  =>array("header"=>"Tipo","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
		"estatus"  =>array("header"=>"Estatus","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
