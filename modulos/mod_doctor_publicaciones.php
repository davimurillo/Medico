...
##  *** put a primary key on the first place 
  $sql="SELECT "
   ."id_publicacion, "
   ."titulo, to_char(fecha_creacion,'DD/MM/YYYY') AS fecha, imagen,"
...
##  *** set columns in view mode
 ...
 $vm_colimns = array(
	"imagen"=>array("header"=>"Imagen", "type"=>"image",      "align"=>"left", "width"=>"10%", "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal", "summarize"=>"false", "sort_type"=>"string", "sort_by"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"../img/publicaciones/", "default"=>"", "image_width"=>"50px", "image_height"=>"30px", "linkto"=>"", "magnify"=>"true", "magnify_type"=>"lightbox", "magnify_power"=>"2"),
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   ...
   "imagen"  =>array("header"=>"Imagen", "type"=>"image",      "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "target_path"=>"../img/publicaciones/", "allow_image_updating"=>"false", "max_file_size"=>"2M", "image_width"=>"150vw", "image_height"=>"80vh", "resize_image"=>"false", "resize_width"=>"128px", "resize_height"=>"128px", "magnify"=>"false", "magnify_type"=>"lightbox", "magnify_power"=>"2", "file_name"=>"", "host"=>"local", "allow_downloading"=>"false", "allowed_extensions"=>""),
	...
	"publicacion" =>array("header"=>"Publicación", "type"=>"textarea", "width"=>"100%", "rows"=>"20", "req_type"=>"ry", "title"=>"", "unique"=>false),
	"estatus" =>array(
												"header"=>"Estatus",
												"type"=>"enum",     
...
$('.ayuda').click(function() {
 ...
 <?php if ($_POST['f_mode']=='edit'){ ?>
  <script>
	  ...
	  CKEDITOR.replace( 'ryypublicacion', {
